...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="../resource-hotel/" type="text/css">
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            <ul>
                ...
                <li class="active"><a href="./about-us.html">호텔</a></li>
    ...
    <section class="aboutus-page-section spad mt-5">
        <div class="container">
            <div class="about-page-text">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ap-title">
                            <h3>방문을 환영합니다!</h3>
                            <p class="mt-3">1910년에 지어진 우리 호텔은 제주도 관광 명소에 쉽게 접근할 수 있도록 제주 중심부에 위치하고 있습니다. 세련된 장식이 돋보이는 객실을 제공합니다. </p>
                        </div>
                    </div>
                    <div class="col-lg-5 offset-lg-1">
                        <ul class="ap-services">
                            <li><i class="icon_check"></i> 숙박 10% 할인</li>
                            <li><i class="icon_check"></i> 무료 1일 조식 체험권</li>
                            <li><i class="icon_check"></i> 무료 Wifi</li>
                            <li><i class="icon_check"></i> 레스토랑 10% 할인</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="about-page-services">
                <div class="row">
                    <div class="col-md-4">
                        <div class="ap-service-item set-bg" data-setbg="../resource-hotel/img/about/about-p1.jpg">
                            <div class="api-text">
                                <h3>레스토랑</h3>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="ap-service-item set-bg" data-setbg="../resource-hotel/img/about/about-p2.jpg">
                            <div class="api-text">
                                <h3>호텔 주관 투어</h3>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="ap-service-item set-bg" data-setbg="../resource-hotel/img/about/about-p3.jpg">
                            <div class="api-text">
                                <h3>이벤트</h3>
                            </div>
                        </div>
    ...
    <!-- Video Section Begin -->
    <section class="video-section set-bg" data-setbg="../resource-hotel/img/video-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        <h2>호텔 살펴보기</h2>
                        <p>아래를 클릭해 호텔 근처 도로를 드라이브해보세요</p>
                        <a href="https://www.youtube.com/watch?v=EzKkl64rRbM" class="play-btn video-popup"><img
                                src="../resource-hotel/img/play.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="gallery-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="gallery-item set-bg" data-setbg="../resource-hotel/img/gallery/gallery-1.jpg">
                        <div class="gi-text">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="gallery-item set-bg" data-setbg="../resource-hotel/img/gallery/gallery-3.jpg">
                                <div class="gi-text">
                                    <h3>Hotel Lobby</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="gallery-item set-bg" data-setbg="../resource-hotel/img/gallery/gallery-4.jpg">
                                <div class="gi-text">
                ...
                <div class="col-lg-6">
                    <div class="gallery-item large-item set-bg" data-setbg="../resource-hotel/img/gallery/gallery-2.jpg">
                        <div class="gi-text">
                            <h3>Hotel Hallway</h3>
                        </div>
                    </div>
